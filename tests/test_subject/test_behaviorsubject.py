...
def test_canceled():
    ...
    assert results1.messages == [on_next(300, 100)]

    assert results2.messages == [on_next(400, 100), on_completed(630)]
...
def test_subject_disposed():
    ...
    assert results3.messages == [on_next(400, 3), on_next(450, 4), on_next(550, 5)]
