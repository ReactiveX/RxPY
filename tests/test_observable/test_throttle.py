...
class TestThrottle(unittest.TestCase):
    def test_throttle_timespan_allpass(self):
    ...
    def test_throttle_timespan_allpass_error_end(self):
        ex = 'ex'
        scheduler = TestScheduler()
    ...
    def test_throttle_timespan_alldrop(self):
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, 1), on_next(200, 2), on_next(250, 3), on_next(300, 4), on_next(350, 5), on_next(400, 6), on_next(450, 7), on_next(500, 8), on_completed(550))
    ...
    def test_throttle_timespan_alldrop_error_end(self):
        ex = 'ex'
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, 1), on_next(200, 2), on_next(250, 3), on_next(300, 4), on_next(350, 5), on_next(400, 6), on_next(450, 7), on_next(500, 8), on_error(550, ex))
    ...
    def test_throttle_timespan_some_drop(self):
        scheduler = TestScheduler()
    ...
    def test_throttle_duration_delay_behavior(self):
        scheduler = TestScheduler()
    ...
    def test_throttle_duration_throttle_behavior(self):
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, -1), on_next(250, 0), on_next(280, 1), on_next(310, 2), on_next(350, 3), on_next(400, 4), on_completed(550))
    ...
    def test_throttle_duration_early_completion(self):
        scheduler = TestScheduler()
    ...
    def test_throttle_duration_inner_error(self):
        scheduler = TestScheduler()
    ...
    def test_throttle_duration_outer_error(self):
        ex = 'ex'
        scheduler = TestScheduler()
    ...
    def test_throttle_duration_selector_throws(self):
        ex = 'ex'
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, 1), on_next(250, 2), on_next(350, 3), on_next(450, 4), on_completed(550))
    ...
    def test_throttle_duration_inner_done_delay_behavior(self):
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, 1), on_next(250, 2), on_next(350, 3), on_next(450, 4), on_completed(550))
    ...
    def test_throttle_duration_inner_done_throttle_behavior(self):
        scheduler = TestScheduler()
