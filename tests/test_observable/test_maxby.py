...
class TestMaxBy(unittest.TestCase):
    ...
    def test_maxby_some(self):
        ...
        msgs = [
            on_next(150, {"key": 1, "value": "z"}),
            on_next(210, {"key": 3, "value": "b"}),
            on_next(220, {"key": 4, "value": "c"}),
            on_next(230, {"key": 2, "value": "a"}),
            on_completed(250),
        ]
        xs = scheduler.create_hot_observable(msgs)
    ...
    def test_maxby_multiple(self):
        ...
        msgs = [
            on_next(150, {"key": 1, "value": "z"}),
            on_next(210, {"key": 3, "value": "b"}),
            on_next(215, {"key": 2, "value": "d"}),
            on_next(220, {"key": 3, "value": "c"}),
            on_next(225, {"key": 2, "value": "y"}),
            on_next(230, {"key": 4, "value": "a"}),
            on_next(235, {"key": 4, "value": "r"}),
            on_completed(250),
        ]
        xs = scheduler.create_hot_observable(msgs)
