...
class TestSelectMany(unittest.TestCase):
    ...
    def test_select_many_then_complete_complete(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), send(600, "qux"), send(600, "bar"), send(650, "baz"), send(650, "foo"), send(700, "qux"), send(700, "bar"), send(750, "baz"), send(800, "qux"), close(850))
    ...
    def test_select_many_then_complete_complete_2(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), send(600, "qux"), send(600, "bar"), send(650, "baz"), send(650, "foo"), send(700, "qux"), send(700, "bar"), send(750, "baz"), send(800, "qux"), close(900))
    ...
    def test_select_many_then_never_complete(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), send(600, "qux"), send(600, "bar"), send(650, "baz"), send(650, "foo"), send(700, "qux"), send(700, "bar"), send(750, "baz"), send(750, "foo"), send(800, "qux"), send(800, "bar"), send(850, "baz"), send(900, "qux"), send(950, "foo"))
    ...
    def test_select_many_then_complete_never(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), send(600, "qux"), send(600, "bar"), send(650, "baz"), send(650, "foo"), send(700, "qux"), send(700, "bar"), send(750, "baz"), send(800, "qux"))
        xs.subscriptions.assert_equal(subscribe(200, 700))
    ...
    def test_select_many_then_complete_error(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), throw(600, ex))
    ...
    def test_select_many_then_error_complete(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), send(550, "baz"), send(550, "foo"), send(600, "qux"), send(600, "bar"), send(650, "baz"), send(650, "foo"), throw(700, ex))
        xs.subscriptions.assert_equal(subscribe(200, 700))
    ...
    def test_select_many_then_error_error(self):
        ...
        results.messages.assert_equal(send(350, "foo"), send(400, "bar"), send(450, "baz"), send(450, "foo"), send(500, "qux"), send(500, "bar"), throw(550, ex))
    ...
    def test_select_many_complete(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), send(560, 301), send(580, 202), send(590, 203), send(600, 302), send(620, 303), send(740, 106), send(810, 304), send(860, 305), send(930, 401), send(940, 402), close(960))
        xs.subscriptions.assert_equal(subscribe(200, 900))
    ...
    def test_select_many_complete_inner_not_complete(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), send(560, 301), send(580, 202), send(590, 203), send(600, 302), send(620, 303), send(740, 106), send(810, 304), send(860, 305), send(930, 401), send(940, 402))
        xs.subscriptions.assert_equal(subscribe(200, 900))
        xs.messages[2].value.value.subscriptions.assert_equal(subscribe(300, 760))
    ...
    def test_select_many_error_outer(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), send(560, 301), send(580, 202), send(590, 203), send(600, 302), send(620, 303), send(740, 106), send(810, 304), send(860, 305), throw(900, ex))
        xs.subscriptions.assert_equal(subscribe(200, 900))
        xs.messages[2].value.value.subscriptions.assert_equal(subscribe(300, 760))
        xs.messages[3].value.value.subscriptions.assert_equal(subscribe(400, 605))
    ...
    def test_select_many_error_inner(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), send(560, 301), send(580, 202), send(590, 203), send(600, 302), send(620, 303), send(740, 106), throw(760, ex))
    ...
    def test_select_many_dispose(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), send(560, 301), send(580, 202), send(590, 203), send(600, 302), send(620, 303))
        xs.subscriptions.assert_equal(subscribe(200, 700))
    ...
    def test_select_many_throw(self):
        ...
        results.messages.assert_equal(send(310, 102), send(390, 103), send(410, 104), send(490, 105), throw(550, ex))
        xs.subscriptions.assert_equal(subscribe(200, 550))
    ...
    def test_select_many_use_function(self):
        ...
        results.messages.assert_equal(send(220, 4), send(230, 3), send(230, 4), send(240, 3), send(240, 4), send(250, 3), send(250, 4), send(260, 5), send(270, 5), send(280, 1), send(280, 5), send(290, 5), send(300, 5), close(300))
