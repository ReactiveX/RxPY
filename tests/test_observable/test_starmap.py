...
class TestSelect(unittest.TestCase):
    ...
    def test_starmap_subscription_error(self) -> None:
        mapper: Callable[
            [Observable[tuple[int, int]]], Observable[tuple[int, int]]
    ...
    def test_starmap_dispose_inside_mapper(self) -> None:
        ...
        d.disposable = (
            xs.pipe(ops.starmap(mapper)).subscribe(results, scheduler=scheduler)
        )
...
class TestStarmapIndexed(unittest.TestCase):
    def test_starmap_indexed_throws(self) -> None:
        ...
        mapper: Callable[
            [Observable[tuple[int, int, int]]], Observable[int]
