...
class TestFind(unittest.TestCase):
    ...
    def test_find_empty(self):
        scheduler = TestScheduler()
        xs = scheduler.create_hot_observable(on_next(150, 1), on_completed(210))
        ...
        assert res.messages == [on_next(210, None), on_completed(210)]
    ...
    def test_find_notfound(self):
        ...
        assert res.messages == [on_next(220, None), on_completed(220)]
