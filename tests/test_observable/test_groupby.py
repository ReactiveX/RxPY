...
class TestGroupBy(unittest.TestCase):
    ...
    #     c["results"]['foo'].assert messages == [
    #         send(470, " OOF"),
    #         send(530, "    oOf    "),
    #         close(570)]
    #     c["results"]['bar'].assert messages == [
    #         send(390, "rab   "),
    #         send(420, "  RAB "),
    #         close(570)]
    #     c["results"]['baz'].assert messages == [
    #         send(480, "  zab"),
    #         send(510, " ZAb "),
    #         close(570)]
    #     c["results"]['qux'].assert messages == [
    #         close(570)]
    ...
    #         send(530, "    oOf    "),
    #         close(570)]
    #     results['bar'].assert messages == [
    #         send(270, "  Rab"),
    #         send(390, "rab   "),
    #         send(420, "  RAB "),
    #         close(570)]
    #     results['baz'].assert messages == [
    #         send(350, "   zaB "),
    #         send(480, "  zab"),
    #         send(510, " ZAb "),
    #         close(570)]
    #     results['qux'].assert messages == [
    #         send(360, " xuq  "),
    #         close(570)]
    #     assert xs.subscriptions == [
    #         subscribe(200, 570)]
