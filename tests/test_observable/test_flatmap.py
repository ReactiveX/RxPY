...
class TestFlatMap(unittest.TestCase):
    ...
    def test_flat_map_complete(self):
        ...
        xs = scheduler.create_hot_observable(
            ...
            on_next(
                400,
                scheduler.create_cold_observable(
                    on_next(180, 202), on_next(190, 203), on_completed(205)
                ),
            ),
            on_next(
                550,
            ...
            on_next(
                850,
                scheduler.create_cold_observable(
                    on_next(80, 401), on_next(90, 402), on_completed(100)
                ),
            ),
            on_completed(900),
        )
    ...
    def test_flat_map_complete_inner_not_complete(self):
        ...
        xs = scheduler.create_hot_observable(
            ...
            on_next(
                400,
                scheduler.create_cold_observable(on_next(180, 202), on_next(190, 203)),
            ),
            on_next(
                550,
                scheduler.create_cold_observable(
