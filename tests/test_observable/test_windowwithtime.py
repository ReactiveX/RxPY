...
class TestWindowWithTime(unittest.TestCase):
    ...
    def test_window_time_basic(self):
        ...
        def create():
            ...
            return xs.window_with_time(100).map_indexed(selector).merge_all()
    ...
    def test_window_time_basic_both(self):
        ...
        def create():
            def selector(ys, i):
                ...
                return ys.map(proj).concat(Observable.return_value('%s end' % i))
            return xs.window_with_time(100, 50).map_indexed(selector).merge_all()
    ...
    def test_window_with_time_basic(self):
        ...
        def create():
            ...
            return xs.window_with_time(100, 70).map_indexed(selector).merge_all()
    ...
    def test_window_with_time_basic_same(self):
        ...
        assert results.messages == [send(210, "0 2"), send(240, "0 3"), send(280, "0 4"), send(320, "1 5"), send(350, "1 6"), send(380, "1 7"), send(420, "2 8"), send(470, "2 9"), close(600)]
        assert xs.subscriptions == [subscribe(200, 600)]
