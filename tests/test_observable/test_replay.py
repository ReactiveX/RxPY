...
# def test_replayCount_Dispose(self):
#     var connection, results, scheduler, subscription, xs, ys
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.create_observer()
...
#     scheduler.schedule_absolute(475, function () {
#         subscription.dispose()
...
# def test_replayCount_MultipleConnections(self):
...
# def test_replayCountLambda_Zip_Complete(self):
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
...
# def test_replayCountLambda_Zip_Error(self):
...
# def test_replayCountLambda_Zip_Dispose(self):
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.startWithDispose(function () {
#         return xs.replay(function (_xs) {
...
# def test_replayTime_Basic(self):
#     var connection, results, scheduler, subscription, xs, ys
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.create_observer()
#     scheduler.schedule_absolute(created, function () {
#         ys = xs.replay(None, None, 150, scheduler)
...
# def test_replayTime_Error(self):
...
#     results = scheduler.create_observer()
#     scheduler.schedule_absolute(created, function () {
#         ys = xs.replay(None, None, 75, scheduler)
...
# def test_replayTime_Complete(self):
#     var connection, results, scheduler, subscription, xs, ys
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.create_observer()
#     scheduler.schedule_absolute(created, function () {
#         ys = xs.replay(None, None, 85, scheduler)
...
# def test_replayTime_Dispose(self):
#     var connection, results, scheduler, subscription, xs, ys
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.create_observer()
#     scheduler.schedule_absolute(created, function () {
#         ys = xs.replay(None, None, 100, scheduler)
...
# def test_replayTime_MultipleConnections(self):
#     var connection1, connection2, connection3, xs, ys
#     xs = Observable.never()
...
# def test_replayTimeLambda_Zip_Complete(self):
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.startWithDispose(function () {
#         return xs.replay(function (_xs) {
...
# def test_replayTimeLambda_Zip_Error(self):
#     var ex, results, scheduler, xs
#     ex = 'ex'
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_error(600, ex))
...
# def test_replayTimeLambda_Zip_Dispose(self):
#     scheduler = TestScheduler()
#     xs = scheduler.create_hot_observable(on_next(110, 7), on_next(220, 3), on_next(280, 4), on_next(290, 1), on_next(340, 8), on_next(360, 5), on_next(370, 6), on_next(390, 7), on_next(410, 13), on_next(430, 2), on_next(450, 9), on_next(520, 11), on_next(560, 20), on_completed(600))
#     results = scheduler.startWithDispose(function () {
#         return xs.replay(function (_xs) {
