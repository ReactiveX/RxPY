...
class TestSkipLastWithTime(unittest.TestCase):
    ...
    def test_skiplast_zero2(self):
        ...
        res.messages.assert_equal(send(210, 1), send(220, 2), send(230, 3), close(230))
        xs.subscriptions.assert_equal(subscribe(200, 230))
    ...
    def test_skiplast_some1(self):
        ...
        res.messages.assert_equal(send(230, 1), close(230))
        xs.subscriptions.assert_equal(subscribe(200, 230))
    ...
    def test_skiplast_some2(self):
        ...
        res.messages.assert_equal(send(260, 1), send(270, 2), send(280, 3), send(290, 4), send(300, 5), close(300))
