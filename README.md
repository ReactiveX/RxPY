# The ReactiveX for MicroPython (micropython-rx) ... #
...
MicroPython-Rx only runs on [Python](http://www.python.org/) 2.7, 3.4 and
[PyPy](http://pypy.org/)
...
Micropython-rx has the following differences from RxPY:

- All time values must be specified as milliseconds using integers
- There is only one Scheduler to use which is the PyboardScheduler
